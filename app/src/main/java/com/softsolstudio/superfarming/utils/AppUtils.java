...
public class AppUtils {
    ...
    public static boolean checkPermissionCamera(final Context context, final int PERMISSION_CODE) {
    ...
    public static boolean checkPermissionWrite(final Context context, final int PERMISSION_CODE) {
        int currentAPIVersion = Build.VERSION.SDK_INT;
        if (currentAPIVersion >= Build.VERSION_CODES.M) {
