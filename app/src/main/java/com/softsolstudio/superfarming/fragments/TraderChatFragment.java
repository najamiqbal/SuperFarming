...
import com.softsolstudio.superfarming.adapters.UserAdapter;
import com.softsolstudio.superfarming.models.Chatlist;
...
public class TraderChatFragment extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recycler_view_trader_chat);
