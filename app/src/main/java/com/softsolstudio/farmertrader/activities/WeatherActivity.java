...
import com.softsolstudio.farmertrader.adapters.ViewPagerAdapter;
import com.softsolstudio.farmertrader.adapters.WeatherRecyclerAdapter;
import com.softsolstudio.farmertrader.fragments.RecyclerViewFragment;
import com.softsolstudio.farmertrader.models.Weather;
import com.softsolstudio.farmertrader.tasks.GenericRequestTask;
import com.softsolstudio.farmertrader.tasks.ParseResult;
import com.softsolstudio.farmertrader.tasks.TaskOutput;
import com.softsolstudio.farmertrader.utils.AlarmReceiver;
import com.softsolstudio.farmertrader.utils.Constants;
import com.softsolstudio.farmertrader.utils.UnitConvertor;
import com.softsolstudio.farmertrader.widgets.AbstractWidgetProvider;
...
public class WeatherActivity extends AppCompatActivity implements LocationListener {
    ...
    private void preloadWeather() {
        ...
        if (!lastToday.isEmpty()) {
            new TodayWeatherTask(this, WeatherActivity.this, progressDialog).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, "cachedResponse", lastToday);
        }
        String lastLongterm = sp.getString("lastLongterm", "");
        if (!lastLongterm.isEmpty()) {
            new LongTermWeatherTask(this,WeatherActivity.this, progressDialog).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, "cachedResponse", lastLongterm);
        }
    }
    ...
    class TodayUVITask extends GenericRequestTask {
        public TodayUVITask(Context context, WeatherActivity activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
