...
import com.softsolstudio.farmertrader.activities.MessageActivity;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    private void lastMessage(final String userid, final TextView last_msg) {
        ...
        UserModelClass userModelClass = SharedPrefManager.getInstance(mContext).getUser();
        final String firebaseUser = userModelClass.getUserfirebase_id();
